...
import { Button, Chip, Section, Divider, Text } from "@Bitforge-LLC/ui";
  ...
  return (
    <>
      ...
      <Section>
        ...
        <Section className="hug mt-4 flex-row flex-wrap gap-4">
      ...
      <Section>
        ...
        <Section className="hug bg-content1 mt-4 items-start gap-3 rounded-lg p-4">
          <Section className="hug flex-row items-center gap-2">
            <Text size="sm" className="text-default-500">
              Status:
            </Text>
            <Chip
